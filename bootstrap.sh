...
###############################################################################
# This function takes care of installing all dependencies for building AMOS on
# Arch linux
# @params:	$1 the emulator to install, virtualbox or qemu
###############################################################################
archLinux()
...
{
	echo "-----------------------"
	echo "|AMOS bootstrap script|"
	echo "-----------------------"
	echo "Usage: ./bootstrap.sh"
	echo "OPTIONS:"
	echo
	echo "   -h,--help      Show this prompt"
	echo "   -u             Update git repo and update rust"
...
boot()
{
	...
	git clone git@github.com:AM-OperatingSystem/amos.git --origin upstream --recursive
	echo "Cleaning up..."
	rm bootstrap.sh
	echo
	echo "---------------------------------------"
	...
	echo "---------------------------------------"
	echo "Run the following commands to build AMOS:"
	echo "cd amos"
	MAKE="make"
